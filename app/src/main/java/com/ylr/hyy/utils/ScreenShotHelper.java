...
import com.ylr.hyy.MVPApplication;
...
public class ScreenShotHelper {
    ...
    * */
public static void saveScreenShot(final Bitmap bitmap, final ViewGroup viewContainer,  MapView mapView, final View...views){
new Thread(){
    public void run(){
        Bitmap screenShotBitmap=getMapAndViewScreenShot(bitmap,viewContainer,mapView,views);
        if(Environment.getExternalStorageState().
                equals(Environment.MEDIA_MOUNTED)) {
//            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+"address.png");

            File file = new File(MVPApplication.mContext.getFilesDir().getAbsolutePath()+File.separator+"address.png");
