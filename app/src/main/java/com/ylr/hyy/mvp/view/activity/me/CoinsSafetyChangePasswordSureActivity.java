 ...
 * 零钱安全设置 改密码 确认密码
 */
public class CoinsSafetyChangePasswordSureActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_coins_safety_setting_changepassword_sure;
    }
    ...
    @OnClick({R.id.iv_title_return, R.id.iv_input_content1, R.id.iv_input_content2, R.id.iv_input_content3, R.id.iv_input_content4, R.id.iv_input_content5, R.id.iv_input_content6, R.id.ll_intercept_event, R.id.tv_change_password_complete})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_intercept_event:
                break;
            case R.id.tv_change_password_complete:
                break;
        }
    }
}
